namespace creArtMain {
    ...
    //FUNKTIONEN
    function drawBackgroundBlue(): void {
        ...
        let gradient: CanvasGradient = crc2.createLinearGradient(0, 0, 1920, 1080);
    ...
    function drawBackgroundRed(): void {

        // Create a linear gradient
        let gradient: CanvasGradient = crc2.createLinearGradient(0, 0, 1920, 1080);

        //gradient stop 1
        let h1: number = Math.floor(Math.random() * 31); //farbe
        let s1: number = Math.floor(Math.random() * 20) + 80; //saturation
        let l1: number = Math.floor(Math.random() * 20) + 30; //luminanz
        let a1: number = 1; //durchsichtigkeit
        //gradient stop 2
        let h2: number = Math.floor(Math.random() * 31); //farbe
        let s2: number = Math.floor(Math.random() * 20) + 80; //saturation
        let l2: number = Math.floor(Math.random() * 20) + 30; //luminanz
        //gradient stop 3
        let h3: number = Math.floor(Math.random() * 31); //farbe
        let s3: number = Math.floor(Math.random() * 20) + 80; //saturation
        let l3: number = Math.floor(Math.random() * 20) + 30; //luminanz
    ...
    function drawBackgroundYellow(): void {

        // Create a linear gradient
        let gradient: CanvasGradient = crc2.createLinearGradient(0, 0, 1920, 1080);

        //gradient stop 1
        let h1: number = Math.floor(Math.random() * 21) + 50; //farbe
        let s1: number = Math.floor(Math.random() * 30) + 70; //saturation
        let l1: number = Math.floor(Math.random() * 20) + 30; //luminanz
        let a1: number = 1; //durchsichtigkeit
        //gradient stop 2
        let h2: number = Math.floor(Math.random() * 21) + 50; //farbe
        let s2: number = Math.floor(Math.random() * 30) + 70; //saturation
        let l2: number = Math.floor(Math.random() * 20) + 30; //luminanz
        //gradient stop 3
        let h3: number = Math.floor(Math.random() * 21) + 50; //farbe
        let s3: number = Math.floor(Math.random() * 30) + 70; //saturation
        let l3: number = Math.floor(Math.random() * 20) + 30; //luminanz
